...
execute if score .newender .data > .newendermax .data positioned -15.0 -51.0 -25.0 run scoreboard players set @e[type=minecraft:endermite,tag=!grounded,distance=..10] freeze 90
