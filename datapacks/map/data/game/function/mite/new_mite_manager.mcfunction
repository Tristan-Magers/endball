...
scoreboard players set .newendermax .data 600
...
execute if score .newender .data > .newendermax .data run execute positioned -15.0 -51.0 -25.0 run function game:game/summonmite
execute if score .newender .data > .newendermax .data positioned -15.0 -51.0 -25.0 run scoreboard players set @e[type=minecraft:endermite,tag=!grounded,distance=..10] freeze 50
