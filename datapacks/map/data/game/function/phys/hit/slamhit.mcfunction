...
execute as @e[tag=det,type=marker,distance=..3.1] at @s run data merge entity @e[tag=move,limit=1,sort=nearest,distance=..1] {Motion:[0.0,0.3,0.0]}
execute as @e[tag=det,type=marker,distance=..3.1] at @s run data merge entity @e[tag=move,limit=1,sort=nearest,distance=..1,tag=grounded] {Motion:[0.0,0.6,0.0]}
...
playsound minecraft:entity.extinguish_fire master @a ~ ~ ~ 1 2
playsound minecraft:entity.death master @a ~ ~ ~ 1 0
