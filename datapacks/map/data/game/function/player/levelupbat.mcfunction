...
item replace entity @s[scores={woodHoe=1..}] hotbar.0 with stone_hoe[item_name='{"text":"Level 1 (right-click to Smash)","italic":false}',unbreakable={},attribute_modifiers=[{id:"attack_speed",type:"generic.attack_speed",amount:100,operation:"add_value"}]]
...
item replace entity @s[scores={stoneHoe=1..}] hotbar.0 with iron_hoe[item_name='{"text":"Level 2 (right-click to Smash)","italic":false}',unbreakable={},attribute_modifiers=[{id:"attack_speed",type:"generic.attack_speed",amount:100,operation:"add_value"}]]
...
item replace entity @s[scores={ironHoe=1..}] hotbar.0 with netherite_hoe[item_name='{"text":"Level 3 (right-click to Smash)","italic":false}',unbreakable={},attribute_modifiers=[{id:"attack_speed",type:"generic.attack_speed",amount:100,operation:"add_value"}]]
...
item replace entity @s[scores={netherHoe=1..}] hotbar.0 with golden_hoe[item_name='{"text":"Level 4 (right-click to Smash)","italic":false}',unbreakable={},attribute_modifiers=[{id:"attack_speed",type:"generic.attack_speed",amount:100,operation:"add_value"}]]
